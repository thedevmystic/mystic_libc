 ...
 * C Runtime Routine.
 *
 * @sa [ROOT]/crt/arm32/crt1.s - Entry point of C Runtime Routine
...
/**
 * @brief Prologue section of init.
 */
.global _init
.section .init, "ax"
.type _init, @function
...
_init:
    ...
    push {r11, lr}
    /* Set frame pointer (r11 = sp) */
    mov  r11, sp

/**
 * @brief Prologue section of fini.
 */
.global _fini
.section .fini, "ax"
.type _fini, @function
